...
// Mock user activities for admin dashboard
export const mockUserActivities: UserActivity[] = [
  {
    ...
    description: 'Uploaded midterm report for AI Task Management project',
  ...
  },
  {
    ...
    description: 'Provided feedback on AR E-Learning platform submission',
  ...
  },
  {
    ...
    description: 'Updated VR Training Simulator project progress to 82%',
  ...
  },
  {
    ...
    description: 'Assigned grade of 92 to Smart Campus IoT final report',
  ...
  },
  {
    ...
    description: 'Uploaded progress report for AR E-Learning project',
...
export const mockRepositoryFiles: RepositoryFile[] = [
  {
    ...
    uploadedBy: 'Admin',
    description: 'Complete guidelines for capstone project requirements and submission standards',
    category: 'guidelines',
    isPublic: true
  },
  {
    ...
    description: 'Standard template for research paper formatting and structure',
    category: 'templates',
    isPublic: true
  },
  {
    ...
    description: 'Professional presentation template for project defenses',
    category: 'templates',
    isPublic: true
  },
  {
    ...
    description: 'Checklist for ensuring ethical considerations in research projects',
    category: 'guidelines',
    isPublic: true
  },
  {
    id: 'repo5',
    name: 'Sample Literature Review.pdf',
    type: 'example',
    size: 1572864,
    uploadedAt: '2024-09-20',
    uploadedBy: 'Dr. Patricia Lee',
    description: 'Example of a well-structured literature review for reference',
    category: 'examples',
    isPublic: true
  },
  {
    id: 'repo6',
    name: 'Technical Writing Guide.pdf',
    type: 'guide',
    size: 2621440,
    uploadedAt: '2024-09-25',
    uploadedBy: 'Prof. James Taylor',
    description: 'Comprehensive guide for technical writing in computer science',
    category: 'guides',
    isPublic: true
  },
  {
    id: 'repo7',
    name: 'Data Analysis Tools.zip',
    type: 'software',
    size: 15728640,
    uploadedAt: '2024-10-01',
    uploadedBy: 'Prof. Robert Kim',
    description: 'Collection of data analysis tools and scripts for research',
    category: 'tools',
    isPublic: false
  },
  {
    id: 'repo8',
    name: 'Citation Styles Guide.pdf',
    type: 'guide',
    size: 819200,
    uploadedAt: '2024-10-05',
    uploadedBy: 'Dr. Michelle Davis',
    description: 'Guide to proper citation formats for academic papers',
    category: 'guides',
    isPublic: true
  }
];